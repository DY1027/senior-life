...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#FDF7E7", padding: "20px" }}>
      <div style={{ background: "#fff", borderRadius: 20, padding: "40px 36px", width: "100%", maxWidth: 400, boxShadow: "0 8px 32px rgba(27,111,200,0.1)" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div style={{ width: 48, height: 48, borderRadius: "50%", background: "linear-gradient(135deg,#C4621A,#E67E3F)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" fill="white"/></svg>
          </div>
          <h1 style={{ fontSize: 22, fontWeight: 800, color: "#3B3226", marginBottom: 6 }}>시니어 든든</h1>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24 }}>
          ...
          <button onClick={handleGoogle} style={{ height: 52, borderRadius: 12, border: "1px solid #E5E7EB", background: "#fff", color: "#3B3226", fontSize: 15, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
        ...
        {sent ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            />
            <button onClick={handleEmail} disabled={!email || loading} style={{ height: 52, borderRadius: 12, border: "none", background: "#C4621A", color: "#fff", fontSize: 15, fontWeight: 700, cursor: "pointer", opacity: (!email || loading) ? 0.6 : 1 }}>
