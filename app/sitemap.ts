...
const publicRoutes = [
  ...
  { path: "/shopping", changeFrequency: "weekly", priority: 0.9 },
  { path: "/shopping/missions/first-usb-c-cable", changeFrequency: "monthly", priority: 0.8 },
  { path: "/shopping/missions/rainy-budget-30000", changeFrequency: "monthly", priority: 0.8 },
  { path: "/shopping/missions/compare-usb-c-cables", changeFrequency: "monthly", priority: 0.75 },
  { path: "/shopping/missions/find-order-mistake", changeFrequency: "monthly", priority: 0.75 },
