...
export const metadata: Metadata = {
  title: "장기요양보험 등급 신청 방법 — 1~5등급 판정 기준 (2024년)",
...
const faqItems = [
  { question: "장기요양보험료는 따로 내야 하나요?", answer: "별도로 내지 않습니다. 건강보험료에 장기요양보험료가 포함되어 함께 부과됩니다. 2024년 기준 건강보험료의 12.95%가 장기요양보험료로 책정됩니다." },
...
export default function LongTermCarePage() {
  return (
    <>
      <ArticleSchema title="장기요양보험 등급 신청 방법" description="장기요양보험 등급 신청 방법과 1~5등급 판정 기준을 안내합니다." datePublished="2024-01-01" dateModified="2024-11-01" url="https://senior-life.kr/welfare/long-term-care" />
