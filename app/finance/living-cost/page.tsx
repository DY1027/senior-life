...
export const metadata: Metadata = {
  title: "노후 생활비 계산기 — 얼마가 필요할까? (2026년 기준)",
...
const faqItems = [
  ...
  { question: "국민연금만으로 노후 생활이 가능한가요?", answer: "2025년 기준 국민연금 평균 수령액은 월 약 67만 원으로, 국민연금연구원 조사의 1인 최소 노후 생활비(약 139만 원)에 크게 미치지 못합니다. 국민연금 외에 개인연금·퇴직연금·기초연금 등을 함께 준비하는 것이 좋습니다." },
...
export default function LivingCostPage() {
  return (
    <>
      <ArticleSchema title="노후 생활비 계산기" description="가구 유형·거주 지역·생활 수준에 따른 월 생활비 예상액을 계산합니다." datePublished="2024-01-01" dateModified="2026-07-14" url="https://seniordeundun.com/finance/living-cost" />
      <div style={{ background: "#FAFAF8", borderBottom: "0.5px solid #EEECE6", padding: "32px 24px 28px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 14, fontSize: 11, color: "#9B9890" }}>
            <span style={{ display: "flex", alignItems: "center", gap: 4 }}><i className="ti ti-calendar" style={{ fontSize: 12 }} aria-hidden="true" />2026년 기준 · 국민연금연구원 조사</span>
