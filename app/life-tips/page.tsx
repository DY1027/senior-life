...
const articles = [
  { title: "시니어 할인 카드 총정리 — 교통·문화·쇼핑", desc: "65세 이상이 받을 수 있는 교통·문화시설·쇼핑 할인 혜택을 한눈에 정리했습니다.", href: "/life-tips/senior-discount", tag: "할인혜택", icon: "ti-ticket", tagBg: "#F5F3FF", tagColor: "#6D28D9", tagBorder: "#DDD6FE" },
  { title: "부모님 돌봄 가족을 위한 체크리스트", desc: "재가 돌봄 시 확인해야 할 항목, 위급 상황 대처 방법, 돌봄 번아웃 예방 가이드입니다.", href: "/life-tips/family-care", tag: "가족돌봄", icon: "ti-heart", tagBg: "#F5F3FF", tagColor: "#6D28D9", tagBorder: "#DDD6FE" },
];
