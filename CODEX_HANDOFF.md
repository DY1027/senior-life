...
> 최종 갱신: 2026-07-16 (Claude 세션 — 오류 이벤트 5종 배포 직후)
...
- **검증 상태**: 클린 빌드 ✅ · tsc 0오류 ✅ · lint 0경고 ✅ · Playwright e2e 14/14 ✅
...
1. 잔여 오류 아이디어: 품절 대체 선택(임무 either-of 의미론 필요), 무게 불일치, 성인 확인
...
2. **배포마다 `public/sw.js`의 `VERSION`을 올릴 것** — 안 올리면 방문자에게 이전 캐시가 남는다 (현재 v2)
