...
const services = [
  ...
  { icon: "🏛️", title: "내 혜택 찾아보기", desc: "나에게 해당될 수 있는 복지혜택을 확인해봅니다.", href: "/welfare", badge: "준비 중", badgeColor: "#9CA3AF", bg: "#F9FAFB" },
  { icon: "💊", title: "복용약 요약표", desc: "복용 중인 약을 정리해 병원에 보여줄 수 있습니다.", href: "/health", badge: "준비 중", badgeColor: "#9CA3AF", bg: "#F9FAFB" },
